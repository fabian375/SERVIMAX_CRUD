...
<body>
				...
				<li>
					<div class="box">
						<figure><img src="<?php echo $row['imagen'] ?>">
							<figcaption>
								<h3> <?php echo $row['descripcion'] . " " . $row['modelo'] ?> </h3>
	...
	<nav>
			<ul>
				<li><a href="https://wa.me/541151783259"><img src="images_1/whatsapp.svg" alt=""></a></li>
				<li><a href="https://www.facebook.com/ServiMax20"><img src="images_1/facebook.svg" alt=""></a></li>
				<li><a href="https://www.instagram.com/servimax20"><img src="images_1/instagram icon.svg" alt=""></a></li>
